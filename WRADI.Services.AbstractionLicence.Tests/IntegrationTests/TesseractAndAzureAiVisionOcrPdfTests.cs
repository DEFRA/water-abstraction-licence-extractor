...
public class TesseractAndAzureAiVisionOcrPdfTests
{
    ...
    public async Task WhenComplicatedFile_ThenGetPurposesPointsAbstractionLimitsCorrectly()
    {
        ...
        Assert.Equal("(2)", licence.AbstractionLimits.Individual[0].Limits[0].Purposes![1].Id);
        Assert.True(licence.AbstractionLimits.Individual[0].Limits[0].Purposes![1].IsImplicit);
        ...
        Assert.Equal("A", licence.AbstractionLimits.Individual[0].Limits[1].Points![0].Id);
        ...
        Assert.Equal("(1)", licence.AbstractionLimits.Individual[0].Limits[1].Purposes![0].Id);
        Assert.True(licence.AbstractionLimits.Individual[0].Limits[1].Purposes![0].IsImplicit);
        Assert.Equal("(2)", licence.AbstractionLimits.Individual[0].Limits[1].Purposes![1].Id);
        Assert.True(licence.AbstractionLimits.Individual[0].Limits[1].Purposes![1].IsImplicit);
        ...
        Assert.Equal("A", licence.AbstractionLimits.Individual[0].Limits[2].Points![0].Id);
        ...
        Assert.Equal("(1)", licence.AbstractionLimits.Individual[0].Limits[2].Purposes![0].Id);
        Assert.True(licence.AbstractionLimits.Individual[0].Limits[2].Purposes![0].IsImplicit);
        Assert.Equal("(2)", licence.AbstractionLimits.Individual[0].Limits[2].Purposes![1].Id);
        Assert.True(licence.AbstractionLimits.Individual[0].Limits[2].Purposes![1].IsImplicit);
        ...
        Assert.Equal("(1)", licence.AbstractionLimits.Individual[1].Limits[0].Purposes![0].Id);
        ...
        Assert.Equal("thousand cubic metres", licence.AbstractionLimits.Individual[2].Limits[0].Units);
        Assert.Equal(1, licence.AbstractionLimits.Individual[2].Limits[0].Value);
        Assert.Equal(LimitPeriodType.PerYear, licence.AbstractionLimits.Individual[2].Limits[0].PeriodType);
        Assert.Single(licence.AbstractionLimits.Individual[2].Limits[0].Points!);
        Assert.Equal("A", licence.AbstractionLimits.Individual[2].Limits[0].Points![0].Id);
        Assert.True(licence.AbstractionLimits.Individual[2].Limits[0].Points![0].IsImplicit);
        Assert.Single(licence.AbstractionLimits.Individual[2].Limits[0].Purposes!);
        Assert.Equal("(2)", licence.AbstractionLimits.Individual[2].Limits[0].Purposes![0].Id);
        Assert.False(licence.AbstractionLimits.Individual[2].Limits[0].Purposes![0].IsImplicit);
