...
public class AzureAiServicesDocumentIntelligenceOcrPdfTests(FirstNamesFixture firstNamesFixture)
{
    ...
    public async Task ScannedFileUploaded_ThenFindXuncorn_DebuggingTest()
    {
        ...
        if (File.Exists("Licence - Old 6082700/AzureAiServicesDocumentIntelligenceOcr/Text/ocr-page-1-image-1.json"))
        {
            File.Delete("Licence - Old 6082700/AzureAiServicesDocumentIntelligenceOcr/Text/ocr-page-1-image-1.json");
        }
    ...
    public async Task When_YorkshireWaterCompany2_ThenY()
    {
        ...
        Assert.Single(points.SubResults);
