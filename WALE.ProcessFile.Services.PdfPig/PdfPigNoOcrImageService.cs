...
{
    public async Task<string?> SaveImageBytesAsync(string filePath, int imageNumber, int pageNumber, ICacheService cacheService, int processRunId)
    {
        ...
        var filenameNoExtension = FileHelper.GetFilenameWithoutExtension(filePath)!;
