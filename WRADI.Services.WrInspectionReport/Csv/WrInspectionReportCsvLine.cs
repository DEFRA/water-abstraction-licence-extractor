...
public class WrInspectionReportCsvLine
{
    ...
    public static WrInspectionReportCsvLine FromForm(Models.WrInspectionReport form)
    {
        return new WrInspectionReportCsvLine
        {
            ...
            MeasurementDetails__MeterName = form.MeasurementDetails.Meters?.FirstOrDefault()?.MeterName,
            MeasurementDetails__MeterMake = form.MeasurementDetails.Meters?.FirstOrDefault()?.MeterMake,
            MeasurementDetails__SerialNumber = form.MeasurementDetails.Meters?.FirstOrDefault()?.SerialNumber,
            MeasurementDetails__MeterAssetNumber = form.MeasurementDetails.Meters?.FirstOrDefault()?.MeterAssetNumber,
            MeasurementDetails__Reading = form.MeasurementDetails.Meters?.FirstOrDefault()?.Reading,
            MeasurementDetails__FlowRate = form.MeasurementDetails.Meters?.FirstOrDefault()?.FlowRate,
            MeasurementDetails__Units = form.MeasurementDetails.Meters?.FirstOrDefault()?.Units,
