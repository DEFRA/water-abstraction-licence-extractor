...
public class PdfPigNoOcrPdfTests
{
    ...
    public async Task WhenX_NotCheckingAbstractionLimits_ThenFoundCorrectly_IncludesAgreedSchema()
    {
        ...
        var agreedSchemaLicenceGroup = await WaterAbstractionLicenceSchemaConverter.ToLicenceSetsAsync(
            resultFull,
            FileLicenceMapping,
...
//        Assert.Equal(9, abstractionLimitsSection.SubResults[0].Text!.Count);
    ...
    public async Task When_PurposeHasPointsInIt_ThenNowGetsThem()
    {
        ...
        var licenceGroups = await WaterAbstractionLicenceSchemaConverter.ToLicenceSetsAsync(
            resultFull,
            FileLicenceMapping,
            ImpoundmentLicenceNumbers,
            DeadLicenceNumbers,
        ...
        Assert.Equal(3, agreedSchemaLicence.LinkedLicences[0].FromSection!.Length);
        ...
        Assert.Equal(2, agreedSchemaLicence.LinkedLicences[2].FromSection!.Length);
    ...
    public async Task When_GettingFurtherConditions_ThenNowGetsThem()
    {
        ...
        Assert.Equal(3, agreedSchemaLicence.LinkedLicences[0].FromSection!.Length);
        Assert.Equal("AbstractionLimits", agreedSchemaLicence.LinkedLicences[0].FromSection![0]);
        Assert.Equal("AdditionalInformation", agreedSchemaLicence.LinkedLicences[0].FromSection![1]);
