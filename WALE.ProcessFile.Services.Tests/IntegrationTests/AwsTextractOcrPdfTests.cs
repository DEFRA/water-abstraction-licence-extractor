...
public class AwsTextractOcrPdfTests
{
    ...
    [Theory]
    [InlineData("12100004__Application Transfer Issued Licence - [1982] - (1982).pdf", "7 DAY OF OCTOBER 19 82", "07/10/1982", 3)] // Works in Tesseract+AI too
    [InlineData("22630110__Issued licence- 2-26-30-110 6075592.PDF", "29/10/02", "29/10/2002", 12)] // Does better then Azure AI Vison - that skips word 'issue'
