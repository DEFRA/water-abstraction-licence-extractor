...
public partial class TesseractAndAzureAiVisionOcrPdfTests(SingletonFirstNamesFixture firstNamesFixture)
{
    ...
    public async Task WhenOldEaFile_ThenGetAbstractionLimitsFromOtherConditionsCorrectly()
    {
        ...
        Assert.Equal("Catcleugh Reservoir", agreedSchemaLicence.AbstractionLimits.Individual![0].Points![0].DocumentId); 
        ...
        Assert.Equal("AbstractionLimits", agreedSchemaLicence.AbstractionLimits.Aggregates![0].Limits[0].ContainedIn![0].SectionName);
        Assert.Null( agreedSchemaLicence.AbstractionLimits.Aggregates![0].Limits[0].ContainedIn![0].LinkReason);
        ...
        Assert.Equal("OtherConditions", agreedSchemaLicence.AbstractionLimits.Aggregates![1].Limits[0].ContainedIn![0].SectionName);
        Assert.Equal("ShallNotExceed", agreedSchemaLicence.AbstractionLimits.Aggregates![1].Limits[0].ContainedIn![0].LinkReason);
        ...
        Assert.Equal("Colt Crag Reservoir", agreedSchemaLicence.AbstractionLimits.Aggregates![1].Points![0].DocumentId);
        Assert.Equal("Little Swinburn Reservoir", agreedSchemaLicence.AbstractionLimits.Aggregates![1].Points![1].DocumentId);
        ...
        Assert.Equal("OtherConditions", agreedSchemaLicence.AbstractionLimits.Aggregates![2].Limits[0].ContainedIn![0].SectionName);
        Assert.Equal("AuthorisedBy", agreedSchemaLicence.AbstractionLimits.Aggregates![2].Limits[0].ContainedIn![0].LinkReason);
        ...
        Assert.Equal("Little Swinburn Reservoir", agreedSchemaLicence.AbstractionLimits.Aggregates![2].Points![0].DocumentId);
        Assert.Equal("West Hallington Reservoir", agreedSchemaLicence.AbstractionLimits.Aggregates![2].Points![1].DocumentId); // TODO the resevoirs listed are actually a bit different
