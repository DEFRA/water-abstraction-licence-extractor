# WALE.Lambda.FileProcess.Orchestrator

This project consists of:
* MessageReceivedFunction.cs - Class file containing a class with a single function handler method
...
```
docker build -f WRADI.Lambda.FileProcess.Orchestrator/Dockerfile . -t wradi/fileprocess-orchestrator
```
...
```
cd "WRADI.Lambda.FileProcess/src/WRADI.Lambda.FileProcess"
