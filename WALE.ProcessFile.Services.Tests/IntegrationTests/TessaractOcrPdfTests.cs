...
public class TessaractOcrPdfTests
{
    ...
    public async Task Alternate_WhenOcrSameLineIsCompany1Line_ThenFoundCorrectly()
    {
        ...
        Assert.Equal("28/39/28/0312", licenceNumberResult.Text!.FirstOrDefault()?.Text);
        ...
        Assert.Equal("28/39/28/0507", agreedSchemaLicence.LinkedLicences[0].LicenceNumber);
    ...
    public async Task XYZ_NotCheckingAbstractionLimits_ThenFoundCorrectly()
    {
        ...
        Assert.NotNull(licenceNumberResult);
        Assert.True(licenceNumberResult.IsOcr);
        Assert.Equal("03/074", licenceNumberResult.Text!.FirstOrDefault()?.Text);
    ...
    public async Task XYZ5_NotCheckingAbstractionLimits_ThenFoundCorrectly()
    {
        ...
        // Assert
        Assert.Equal(7, GeneralTestsHelper.ExcludeSomeMatches(resultList).Count); // The document is printed out of alignment and has ghosting
    ...
    public async Task XYZ2_NotCheckingAbstractionLimits_ThenFoundCorrectly()
    {
        ...
        Assert.NotNull(licenceNumberResult);
        Assert.True(licenceNumberResult.IsOcr);
        Assert.Equal("06/076", licenceNumberResult.Text!.FirstOrDefault()?.Text);
    ...
    public async Task AttachedStickerDifferent_WhenNearNextLineIsCompany_ThenFoundCorrectly()
    {
        ...
        Assert.NotNull(licenceNumberResult);
        Assert.True(licenceNumberResult.IsOcr);
        Assert.Equal("29/38/01/0008", licenceNumberResult.Text!.FirstOrDefault()?.Text);
    ...
    public async Task EstateCompany_WhenOcrSameLineIsCompany1Line_ThenFoundCorrectly()
    {
        ...
        Assert.NotNull(licenceNumberResult);
        Assert.True(licenceNumberResult.IsOcr);
        Assert.Equal("28/39/38/0035", licenceNumberResult.Text!.FirstOrDefault()?.Text);
    ...
    public async Task Z_X_ThenFoundCorrectly()
    {
        ...
        Assert.NotNull(licenceNumberResult);
        Assert.True(licenceNumberResult.IsOcr);
        Assert.Equal("8/36/19/*S/0130", licenceNumberResult.Text!.FirstOrDefault()?.Text);
    ...
    public async Task A3_B4_ThenFoundCorrectly()
    {
        ...
        Assert.True(licenceNumberResult.IsOcr);
        Assert.Equal(LabelPosition.LabelIsBeforeTextToFind, licenceNumberResult.MatchedLabel!.Position);        
        Assert.Equal("28/39/22/0427", licenceNumberResult.Text!.FirstOrDefault()?.Text);
        ...
        Assert.Equal(2, agreedSchemaLicenceGroup.Count);
        Assert.Equal("2839220427-LVUNKNOWN", agreedSchemaLicenceGroup[0].LicenceSetId);
        Assert.Equal("0427", agreedSchemaLicenceGroup[0].ShortLicenceSetId);
        Assert.Equal("2839220217-LVUNKNOWN-2839220427-LVUNKNOWN", agreedSchemaLicenceGroup[1].LicenceSetId);
        Assert.Equal("0217-0427", agreedSchemaLicenceGroup[1].ShortLicenceSetId);
        ...
        Assert.Equal("28/39/22/0217", agreedSchemaLicence.LinkedLicences[0].LicenceNumber);
        Assert.Single(agreedSchemaLicence.LinkedLicences[0].ContainedIn!);
        Assert.Equal("AbstractionLimits", agreedSchemaLicence.LinkedLicences[0].ContainedIn![0].SectionName);
        Assert.Equal("AggregateCondition", agreedSchemaLicence.LinkedLicences[0].ContainedIn![0].LinkReason);        
    }
