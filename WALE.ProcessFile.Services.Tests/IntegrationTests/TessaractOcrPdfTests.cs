...
public class TessaractOcrPdfTests(SingletonFirstNamesFixture firstNamesFixture)
{
    ...
    public async Task XYZ_NotCheckingAbstractionLimits_ThenFoundCorrectly()
    {
        ...
        var issuerResult = resultList.FirstOrDefault(result => result.LabelGroupName == "Issuer");
        Assert.NotNull(issuerResult);
        Assert.Equal("ENVIRONMENT AGENC", issuerResult.Text?.FirstOrDefault()?.Text); // National Rivers Authority
    ...
    public async Task A3_B4_ThenFoundCorrectly()
    {
        ...
        Assert.Equal(51.381388473510739, agreedSchemaLicence.LicenceNumber.Confidence);
        Assert.Equal(60.448692321777344, agreedSchemaLicence.LicenceNumber.OcrConfidence);
