...
public class NorthumbrianWaterTemplateConfigurationRule : IRule<TemplateFinderResult>
{
    private readonly List<(string LabelGroupName, List<LabelToMatch> Labels)> _configuration;
    public string RuleName => $"Northumbrian Water Authority";
    ...
    public bool CanApply(MatchesResult content)
    {
        return content.Matches?
            ...
            .Where(m => m.LabelGroupName == "NorthumbrianWater")?.Any() == true;
    }
