...
namespace WRADI.Lambda.FileProcess.WrInspectionReport.Orchestrator;
...
public class MessageReceivedFunction
{
    ...
    {
        context.Logger.LogInformation($"WrInspectionReport File Process Orchestrator received {sqsEvent.Records.Count} SQS message(s).");
